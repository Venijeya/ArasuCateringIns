...
import imgTopLeft  from '../assets/5.jpeg';
import imgTopRight from '../assets/16.JPG';
import imgBottom   from '../assets/1.jpeg';
      ...
      <div className="container">
        <div className="about-grid">
          ...
          <div className="about-content">
            ...
            {/* ── Legacy / History Strip ── */}
            <div className="about-legacy-strip">

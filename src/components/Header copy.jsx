...
const Header = () => {
  ...
  const navItems = [
    ...
    { label: 'About Us', path: '/about' },
    {
      ...
      // children: [
      //   { label: 'Courses 01', path: '/courses' },
      //   { label: 'Courses 02', path: '/courses-2' },
      //   { label: 'Course Details', path: '/courses/digital-marketing' },
      // ]
    },
    // {
    //   label: 'Pages', path: '#',
    ...
    //     { label: 'Blog Style 02', path: '/blog-2' },
      ...
      <div className={`itoffcanvas ${mobileOpen ? 'active' : ''}`}>
        ...
        <div className="offcanvas-info">
          ...
          <div className="info-item">
            ...
            <div><span>Phone</span><a href="tel:8072107164">80721 07164</a></div>
          </div>
          <div className="info-item">
              ...
              <div className="header-top-left">
                <ul>
                  <li className="d-none-sm">
                    ...
                    <a href="tel:8072107164">80721 07164</a>
                  </li>
                  <li>
